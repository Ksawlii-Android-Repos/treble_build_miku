...
## Version
Latest version: 0.12.0-extended

[Downloads](https://github.com/Ksawlii-Android-Repos/treble_build_miku/releases)
...
- Clone this repo:
    ```
    git clone https://github.com/Ksawlii-Android-Repos/treble_build_miku -b Udon_v2-extended
    ```
